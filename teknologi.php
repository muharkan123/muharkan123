                  ...
                  <div class="col-md-6">
                    <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative shadow-lg">
                      <div class="col p-4 d-flex flex-column position-static ">
                        ...
                        <h3 class="mb-0">Mouse Unik Baru Logitech di Indonesia</h3>
                        <div class="mb-1 text-muted">August 2022</div>
                        <p class="mb-auto">Siapa yang tidak kenal Logitech? Perusahaan Swiss ...</p>
                        <a href="tekno1.php" class="stretched-link">Lanjut Membaca</a>
                      </div>
                      <div class="col-auto d-none d-lg-block px-4 mt-5">
                          <img src="asset/images/artikel1.jpg" width="150" height="150">
                      </div>
                    </div>
                  </div>
            </div>
